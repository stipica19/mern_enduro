    ...
    <section className="docs-main apply">
      ...
      <div className="container">
        ...
        <p
          ...
          style={
            display === '22' ? { color: 'red' } : { color: 'white' }
          }
        >
          &#128073; Tours 2022{' '}
        </p>
        <p
          ...
          style={
            display === '23' ? { color: 'red' } : { color: 'white' }
          }
        >
          &#128073; Tours 2023{' '}
        </p>
                ...
                {display == '22'
                  ? termine.map((termine) => (
                      <tr key={termine._id}>
                        ...
                        <td>
                          {moment(termine.checkIn_date).format('l')}
                        </td>
                        <td>
                          {moment(termine.checkOut_date).format('l')}
                        </td>
            ...
            <form ref={form} onSubmit={sendEmail}>
              <div className="form-date grid">
                <div className="date-form">
                  ...
                  {touch
                    ? !isValid && <span>{t('input_field')}</span>
                    : null}
                </div>{' '}
                <TextField
